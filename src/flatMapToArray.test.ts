...
describe("flatMapToArray", () => {
  describe("array", () => {
    it("should map values", () => {
      const result = flatMapToArray([1, 2, 4], (value) =>
    ...
    it("should break on encountering Break", () => {
      const result = flatMapToArray([1, 2, 3], (value) => {
  ...
  describe("set", () => {
    it("should map values", () => {
      const result = flatMapToArray(new Set([1, 2, 3]), (value) =>
        value === 2 ? 4 : [value * 2, value * 3],
      );
  ...
  describe("typedArray", () => {
    it("should map values", () => {
      ...
      biguint64[0] = 42n;
      const result = flatMapToArray(biguint64, (value) => [
        value * 2n,
        value * 3n,
      ]);
    ...
    it("should break on encountering Break", () => {
      ...
      uint8[0] = 1;
      uint8[1] = 2;
      const result = flatMapToArray(uint8, (value) => {
        if (value === 2) return Break;
  ...
  describe("iterator", () => {
    it("should map values", () => {
      ...
      const result = flatMapToArray(iterator, (value) =>
        value === 2 ? 4 : [value * 2, value * 3],
      );

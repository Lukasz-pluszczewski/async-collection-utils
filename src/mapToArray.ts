...
export function mapToArray<TUpdateValue>(
  iterable: true,
  callback: (
    item: number,
    index: number,
...
export function mapToArray<TCollection extends unknown[], TUpdateValue>(
  array: TCollection,
  callback: (
...
export function mapToArray<TCollection extends Set<unknown>, TUpdateValue>(
  set: TCollection,
  callback: (
...
export function mapToArray<TCollection extends TypedArray>(

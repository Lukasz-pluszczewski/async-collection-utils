...
export async function asyncFilter<TCollection extends unknown[]>(
  array: TCollection,
  predicate: (
...
): Promise<Array<TCollection[number]>>;

export async function asyncFilter<TCollection extends Set<unknown>>(
  set: TCollection,
  predicate: (
...
): Promise<Set<TCollection extends Set<infer TValue> ? TValue : never>>;

export async function asyncFilter<TCollection extends Map<unknown, unknown>>(
  map: TCollection,
  predicate: (
...
export async function asyncFilter<TCollection extends TypedArray>(

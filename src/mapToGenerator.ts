...
export function mapToGenerator<TUpdateValue>(
  iterable: true,
  callback: (
    item: number,
    index: number,
...
export function mapToGenerator<TCollection extends unknown[], TUpdateValue>(
  array: TCollection,
  callback: (
...
export function mapToGenerator<TCollection extends Set<unknown>, TUpdateValue>(
  set: TCollection,
  callback: (
...
export function mapToGenerator<
...
export function mapToGenerator<TCollection extends TypedArray>(

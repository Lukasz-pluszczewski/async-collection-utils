...
describe("asyncFlatMapToArray", () => {
  describe("array", () => {
    it("should map values", async () => {
      const result = await asyncFlatMapToArray([1, 2, 4], async (value) =>
    ...
    it("should break on encountering Break", async () => {
      const result = await asyncFlatMapToArray([1, 2, 3], async (value) => {
  ...
  describe("typedArray", () => {
    it("should map values", async () => {
      ...
      biguint64[0] = 42n;
      const result = await asyncFlatMapToArray(biguint64, async (value) => [
        value * 2n,
        value * 3n,
      ]);
    ...
    it("should break on encountering Break", async () => {
      ...
      uint8[0] = 1;
      uint8[1] = 2;
      const result = await asyncFlatMapToArray(uint8, async (value) => {
        if (value === 2) return Break;
  ...
  describe("iterator", () => {
    it("should map values", async () => {
      ...
      const result = await asyncFlatMapToArray(iterator, async (value) =>
        value === 2 ? 4 : [value * 2, value * 3],
      );
  ...
  describe("asyncIterator", () => {
    it("should map values", async () => {
      ...
      const result = await asyncFlatMapToArray(asyncIterator, async (value) =>
        value === 2 ? 4 : [value * 2, value * 3],
      );
    ...
    it("should break on encountering Break", async () => {
      ...
      expect(result).toStrictEqual([2, 14]);
    });
    ...
    it("should save value and break on encountering Last", async () => {
      ...
      expect(result).toStrictEqual([2, 0, 20]);
    });
  });
});
